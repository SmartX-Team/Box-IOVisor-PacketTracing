...
print("ver         Src IP Addr         Dst IP Addr     Port     : Action")
...
while 1:
  ...
  #srcPort = str(bin(packet_bytearray[36])[2:])
  ...
  print("%3s%20s%20s%9s%5s" % (str(int(ipversion, 2)), srcAddr, dstAddr, dstPort, "     : " + action))
